...
export function AlgemeneVoorwaardenModal({ onSluiten }) {
  return (
    <JuridischModal titel="Algemene Voorwaarden" versie={VERSIE} laatstGewijzigd={LAATST_GEWIJZIGD} onSluiten={onSluiten}>
      {`Samenvatting: Constatum is een platform voor het vastleggen en documenteren van omgevingsmeldingen. U bent zelf verantwoordelijk voor de juistheid van uw registraties. Het platform biedt technische ondersteuning maar is geen juridisch adviseur en garandeert geen juridisch succes.

Artikel 1 — Definities
In deze algemene voorwaarden wordt verstaan onder:
• "Platform": Constatum, de webapplicatie beschikbaar via constatum.nl — een geografisch registratieplatform voor het documenteren van omgevingsmeldingen.
• "Gebruiker": iedere natuurlijke persoon die een account aanmaakt op het platform.
• "Melding": een door de gebruiker aangemaakte registratie van een geobserveerde activiteit of situatie in de buitenomgeving, inclusief alle bijbehorende gegevens (locatie, tijdstip, fotomateriaal, weerdata, beschrijving).
• "Dossier": een chronologische verzameling van meldingen van één gebruiker, inclusief de bijbehorende technische metadata (cryptografische hashes, tijdstempels).
• "Buurtdossier": een geanonimiseerde samenvoeging van dossiers van meerdere gebruikers in een geografisch aaneengesloten gebied, samengesteld voor collectieve doeleinden.

Artikel 2 — Toegang en gebruik
Het platform is uitsluitend toegankelijk na registratie met een geldig e-mailadres en verificatie van dat adres. Constatum is bedoeld voor burgers die activiteiten en situaties in hun directe leefomgeving willen documenteren als onderbouwing van een persoonlijk of collectief dossier. De gebruiker dient minimaal 18 jaar oud te zijn. De gebruiker mag het platform uitsluitend gebruiken voor rechtmatige doeleinden in overeenstemming met het Nederlandse recht en het recht van de Europese Unie. Commercieel gebruik van de data of het platform zonder schriftelijke toestemming van Constatum is niet toegestaan.
...
• Gecoördineerde campagnes op te zetten met als primaire doel reputatieschade bij een specifieke persoon of organisatie, zonder dat sprake is van aantoonbare melding.
...
Constatum biedt technische hulpmiddelen voor het documenteren van meldingen, waaronder cryptografische hashing (SHA-256) en tijdstempeling (RFC 3161). Het platform garandeert niet dat geregistreerde meldingen in een specifieke juridische of bestuurlijke procedure als bewijs worden geaccepteerd. De beoordeling van bewijs is voorbehouden aan rechters en bevoegde instanties.
...
Artikel 7 — Buurtdossier en collectieve samenwerking
Deelname aan een buurtdossier is volledig vrijwillig en vereist expliciete opt-in via de app. De coördinator heeft uitsluitend toegang tot geanonimiseerde meldingsdata van gebruikers die zich hebben aangemeld. De coördinator is gebonden aan geheimhouding ten aanzien van de identiteit van individuele gebruikers. Constatum faciliteert de technische samenwerking maar is geen partij in eventuele procedures die uit het buurtdossier voortvloeien. Gebruikers die deelnemen aan een buurtdossier geven toestemming voor het opnemen van hun geanonimiseerde meldingen in een collectief dossier. Zij geven geen toestemming voor het vrijgeven van hun persoonsgegevens aan andere gebruikers.
